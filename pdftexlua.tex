...
'draftmode','pxdimen','insertht','normaldeviate','setrandomseed','primitive'
})}
...
\countdef\pdfshellescape60001 \pdfshellescape=0
\countdef\TeXXeTstate60002 \TeXXeTstate=0
...
\@@!everyjob{\@@!directlua{require("pdftexlua.lua")}\@@!postlua\the\everyjob}
\@@!directlua{require("pdftexlua.lua")}\@@!postlua
\catcode`\{=12
\catcode`\{=12
\catcode`\@=12
\catcode`\!=12
